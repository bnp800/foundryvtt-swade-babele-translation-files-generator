...
│   └── fr.json
├── scripts/
│   ├── dnd-babele-translation-files-generator.mjs  # Entry point, hooks registration
│   ├── app/
...
│   │   ├── actor-exporter.mjs                      # Actor document exporter
│   │   ├── item-exporter.mjs                       # Item document exporter
│   │   ├── scene-exporter.mjs                      # Scene document exporter
│   │   ├── journal-entry-exporter.mjs              # JournalEntry document exporter
...
│       └── FileSaver.js
├── styles/
│   └── dnd-babele-translation-files-generator.css  # Module styles
└── templates/
...
- Concrete exporters (e.g., `ItemExporter`) implement `_processDataset()` for document-specific logic
